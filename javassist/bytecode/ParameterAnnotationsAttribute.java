...
public class ParameterAnnotationsAttribute extends AttributeInfo {
   ...
   public AttributeInfo copy(ConstPool newCp, Map classnames) {
      ...
      ParameterAnnotationsAttribute var10000;
      try {
         copier.parameters();
         var10000 = new ParameterAnnotationsAttribute(newCp, this.getName(), copier.close());
   ...
   public Annotation[][] getAnnotations() {
      Annotation[][] var10000;
      try {
         var10000 = (new AnnotationsAttribute$Parser(this.info, this.constPool)).parseParameters();
