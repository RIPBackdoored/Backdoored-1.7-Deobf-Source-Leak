...
public abstract class Tracer implements TypeTag {
   ...
   protected int doOpcode(int pos, byte[] code) throws BadBytecode {
      ...
      try {
         ...
         if (op < 96) {
            if (op < 54) {
               var10000 = this.doOpcode0_53(pos, code, op);
               return var10000;
            }

            var10000 = this.doOpcode54_95(pos, code, op);
            return var10000;
         }

         if (op < 148) {
            var10000 = this.doOpcode96_147(pos, code, op);
            return var10000;
         }

         var10000 = this.doOpcode148_201(pos, code, op);
