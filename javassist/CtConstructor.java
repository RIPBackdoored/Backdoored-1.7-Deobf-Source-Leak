   ...
   public boolean isEmpty() {
      ...
      if (ca == null) {
         ...
         try {
            ...
            int pos;
            int desc;
            var10000 = op0 == 177 || op0 == 42 && it.byteAt(pos = it.next()) == 183 && (desc = cp.isConstructor(this.getSuperclassName(), it.u16bitAt(pos + 1))) != 0 && "()V".equals(cp.getUtf8Info(desc)) && it.byteAt(it.next()) == 177 && !it.hasNext();
