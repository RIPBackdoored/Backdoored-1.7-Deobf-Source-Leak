...
class Emitter$ExpectFirstFlowMappingKey implements EmitterState {
   // $FF: synthetic field
   final Emitter this$0;

   private Emitter$ExpectFirstFlowMappingKey(Emitter var1) {
      this.this$0 = var1;
   }
   ...
   // $FF: synthetic method
   Emitter$ExpectFirstFlowMappingKey(Emitter x0, Emitter$1 x1) {
      this(x0);
   }
}
