...
public class JSONArray implements Iterable {
   ...
   public Number getNumber(int index) throws JSONException {
      ...
      try {
         ...
         var10000 = JSONObject.stringToNumber(object.toString());
   ...
   public Enum getEnum(Class clazz, int index) throws JSONException {
      Enum val = this.optEnum(clazz, index);
      if (val == null) {
   ...
   public boolean optBoolean(int index, boolean defaultValue) {
      boolean var10000;
      try {
         var10000 = this.getBoolean(index);
      } catch (Exception var4) {
         return defaultValue;
      }
   ...
   public Number optNumber(int index, Number defaultValue) {
      ...
      if (JSONObject.NULL.equals(val)) {
         ...
         Number var10000;
         try {
            var10000 = JSONObject.stringToNumber((String)val);
   ...
   public String toString(int indentFactor) throws JSONException {
      ...
      synchronized(sw.getBuffer()) {
         var10000 = this.write(sw, indentFactor, 0).toString();
      }
