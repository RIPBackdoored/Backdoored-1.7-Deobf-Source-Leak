...
public class JSONObject {
   ...
   public static final Object NULL = new JSONObject$Null((JSONObject$1)null);
   ...
   public Enum getEnum(Class clazz, String key) throws JSONException {
      Enum val = this.optEnum(clazz, key);
      if (val == null) {
   ...
   public Number getNumber(String key) throws JSONException {
      ...
      try {
         if (object instanceof Number) {
            var10000 = (Number)object;
            return var10000;
         }

         var10000 = stringToNumber(object.toString());
   ...
   public Enum optEnum(Class clazz, String key, Enum defaultValue) {
      ...
      try {
         ...
         var10000 = Enum.valueOf(clazz, val.toString());
   ...
   static BigDecimal objectToBigDecimal(Object val, BigDecimal defaultValue) {
      if (NULL.equals(val)) {
         ...
         if (!(val instanceof Long) && !(val instanceof Integer) && !(val instanceof Short) && !(val instanceof Byte)) {
            BigDecimal var10000;
            try {
               var10000 = new BigDecimal(val.toString());
            } catch (Exception var4) {
               return defaultValue;
            }
         ...
         if (!(val instanceof Long) && !(val instanceof Integer) && !(val instanceof Short) && !(val instanceof Byte)) {
            ...
            try {
               ...
               if (isDecimalNotation(valStr)) {
                  var10000 = (new BigDecimal(valStr)).toBigInteger();
                  return var10000;
               }

               var10000 = new BigInteger(valStr);
            } catch (Exception var4) {
               return defaultValue;
            }
   ...
   public Number optNumber(String key, Number defaultValue) {
      ...
      if (NULL.equals(val)) {
         ...
         Number var10000;
         try {
            var10000 = stringToNumber(val.toString());
         } catch (Exception var5) {
            return defaultValue;
         }
   ...
   private static Annotation getAnnotation(Method m, Class annotationClass) {
            ...
            if (c.getSuperclass() == null) {
               ...
               for(int var5 = 0; var5 < var4; ++var5) {
                  ...
                  try {
                     ...
                     var10000 = getAnnotation(im, annotationClass);
                     return var10000;
               ...
               try {
                  var10000 = getAnnotation(c.getSuperclass().getMethod(m.getName(), m.getParameterTypes()), annotationClass);
   ...
   private static int getAnnotationDepth(Method m, Class annotationClass) {
      if (m != null && annotationClass != null) {
         if (m.isAnnotationPresent(annotationClass)) {
            return 1;
         } else {
   ...
   public Object optQuery(JSONPointer jsonPointer) {
      Object var10000;
      try {
         var10000 = jsonPointer.queryFrom(this);
   ...
   public String toString(int indentFactor) throws JSONException {
      ...
      synchronized(w.getBuffer()) {
         var10000 = this.write(w, indentFactor, 0).toString();
      }
   ...
   public static Object wrap(Object object) {
      ...
      try {
         ...
         if (object instanceof Collection) {
            ...
            var7 = new JSONArray(coll);
            return var7;
         }

         if (object.getClass().isArray()) {
            var7 = new JSONArray(object);
            return var7;
         }
         ...
         if (!(object instanceof Map)) {
            ...
            if (!objectPackageName.startsWith("java.") && !objectPackageName.startsWith("javax.") && object.getClass().getClassLoader() != null) {
               var10000 = new JSONObject(object);
               return var10000;
            }

            String var6 = object.toString();
            return var6;
         }

         Map map = (Map)object;
         var10000 = new JSONObject(map);
      } catch (Exception var3) {
         return null;
      }
   ...
   public Writer write(Writer writer, int indentFactor, int indent) throws JSONException {
      ...
      try {
         ...
         writer.write(123);
         if (length == 1) {
            Entry entry = (Entry)this.entrySet().iterator().next();
            ...
            Iterator var7 = this.entrySet().iterator();
