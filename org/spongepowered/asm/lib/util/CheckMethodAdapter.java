...
public class CheckMethodAdapter extends MethodVisitor {
   ...
   public CheckMethodAdapter(int access, String name, String desc, MethodVisitor cmv, Map labels) {
      this(new CheckMethodAdapter$1(327680, access, name, desc, (String)null, (String[])null, cmv), labels);
      this.access = access;
   }
