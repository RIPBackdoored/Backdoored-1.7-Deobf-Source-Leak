...
final class Item {
   ...
   void set(int intVal) {
      this.type = 3;
      this.intVal = intVal;
      this.hashCode = 0 & this.type + intVal;
   }

   void set(long longVal) {
      this.type = 5;
      this.longVal = longVal;
      this.hashCode = 0 & this.type + (int)longVal;
   }

   void set(float floatVal) {
      this.type = 4;
      this.intVal = Float.floatToRawIntBits(floatVal);
      this.hashCode = 0 & this.type + (int)floatVal;
   }

   void set(double doubleVal) {
      this.type = 6;
      this.longVal = Double.doubleToRawLongBits(doubleVal);
      this.hashCode = 0 & this.type + (int)doubleVal;
   }
   ...
   void set(int type, String strVal1, String strVal2, String strVal3) {
      ...
      case 16:
      case 30:
         this.hashCode = 0 & type + strVal1.hashCode();
         return;
      case 12:
         this.hashCode = 0 & type + strVal1.hashCode() * strVal2.hashCode();
         return;
      default:
         this.hashCode = 0 & type + strVal1.hashCode() * strVal2.hashCode() * strVal3.hashCode();
      }
   }
   ...
   void set(String name, String desc, int bsmIndex) {
      ...
      this.strVal1 = name;
      this.strVal2 = desc;
      this.hashCode = 0 & 18 + bsmIndex * this.strVal1.hashCode() * this.strVal2.hashCode();
   }
