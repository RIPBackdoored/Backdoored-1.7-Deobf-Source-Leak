...
class MixinApplicatorStandard {
   ...
   private MixinApplicatorStandard$Range getConstructorRange(MethodNode ctor) {
      ...
      return new MixinApplicatorStandard$Range(this, start, end, superIndex);
   }
   ...
   private MixinApplicatorStandard$InitialiserInjectionMode getInitialiserInjectionMode(MixinEnvironment environment) {
      ...
      if (strMode == null) {
         ...
         MixinApplicatorStandard$InitialiserInjectionMode var10000;
         try {
            var10000 = MixinApplicatorStandard$InitialiserInjectionMode.valueOf(strMode.toUpperCase());
