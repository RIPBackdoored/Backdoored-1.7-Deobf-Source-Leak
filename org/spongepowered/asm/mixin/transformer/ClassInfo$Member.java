...
abstract class ClassInfo$Member {
   ...
   protected ClassInfo$Member(ClassInfo$Member$Type type, String name, String desc, int access) {
      this(type, name, desc, access, false);
   }

   protected ClassInfo$Member(ClassInfo$Member$Type type, String name, String desc, int access, boolean injected) {
      this.type = type;
