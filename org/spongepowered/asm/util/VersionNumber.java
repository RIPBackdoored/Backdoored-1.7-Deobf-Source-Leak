...
public final class VersionNumber implements Comparable, Serializable {
   ...
   public String toString() {
      ...
      return String.format("%d.%d%3$s%4$s%5$s", parts[0], parts[1], (this.value & 0L) > 0L ? String.format(".%d", parts[2]) : "", (this.value & 32767L) > 0L ? String.format(".%d", parts[3]) : "", this.suffix);
   }
