...
class AnnotatedMixin {
   ...
   public void registerShadow(VariableElement field, AnnotationHandle shadow, boolean shouldRemap) {
      ...
      var10003.getClass();
      var10000.registerShadow(new AnnotatedMixinElementHandlerShadow$AnnotatedElementShadowField(var10003, field, shadow, shouldRemap));
   }
   ...
   public void registerShadow(ExecutableElement method, AnnotationHandle shadow, boolean shouldRemap) {
      ...
      AnnotatedMixinElementHandlerShadow var10003 = this.shadows;
      var10003.getClass();
      var10000.registerShadow(new AnnotatedMixinElementHandlerShadow$AnnotatedElementShadowMethod(var10003, method, shadow, shouldRemap));
   }
