...
public class NativeLibrary {
   ...
   private NativeLibrary(String libraryName, String libraryPath, long handle, Map options) {
      ...
      if (Platform.isWindows() && "kernel32".equals(this.libraryName.toLowerCase())) {
         synchronized(this.functions) {
            Function f = new NativeLibrary$1(this, this, "GetLastError", 63, this.encoding);
   ...
   public Pointer getGlobalVariableAddress(String symbolName) {
      Pointer var10000;
      try {
         var10000 = new Pointer(this.getSymbolAddress(symbolName));
