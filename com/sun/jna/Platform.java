...
public final class Platform {
   ...
   public static final boolean is64Bit() {
      ...
      } else if (!"x86-64".equals(ARCH) && !"ia64".equals(ARCH) && !"ppc64".equals(ARCH) && !"ppc64le".equals(ARCH) && !"sparcv9".equals(ARCH) && !"amd64".equals(ARCH)) {
   ...
   private static boolean isSoftFloat() {
      ...
      try {
         ...
         var10000 = ahfd.isArmSoftFloat();
      } catch (IOException var2) {
         Logger.getLogger(Platform.class.getName()).log(Level.FINE, (String)null, var2);
         return false;
      }
