...
public final class Native implements Version {
   ...
   private static final Callback$UncaughtExceptionHandler DEFAULT_HANDLER = new Native$1();
      ...
      if (len == 0) {
         ...
         if (encoding != null) {
            label22: {
               String var10000;
               try {
                  var10000 = new String(buf, 0, len, encoding);
   ...
   private static Object lookupField(Class mappingClass, String fieldName, Class resultClass) {
      ...
      try {
         ...
         field.setAccessible(true);
         var10000 = field.get((Object)null);
   ...
   public static Library synchronizedLibrary(Library library) {
      ...
      if (!Proxy.isProxyClass(cls)) {
         ...
         if (!(ih instanceof Library$Handler)) {
            ...
            InvocationHandler newHandler = new Native$3(handler, library);
   ...
   public static String getWebStartLibraryPath(String libName) {
      if (System.getProperty("javawebstart.version") == null) {
         ...
         try {
            ...
            Method m = (Method)AccessController.doPrivileged(new Native$4());
            String libpath = (String)m.invoke(cl, libName);
            if (libpath != null) {
               var10000 = (new File(libpath)).getParent();
               return var10000;
            }
   ...
   static void removeTemporaryFiles() throws IOException {
      File dir = getTempDir();
      FilenameFilter filter = new Native$5();
   ...
   static Class findDirectMappedClass(Class cls) {
      ...
      if (idx != -1) {
         ...
         Class var10000;
         try {
            var10000 = findDirectMappedClass(Class.forName(name, true, cls.getClassLoader()));
   ...
   static Class getCallingClass() {
      Class[] context = (new Native$6()).getClassContext();
      if (context == null) {
   ...
   public static boolean registered(Class cls) {
      boolean var10000;
      synchronized(registeredClasses) {
         var10000 = registeredClasses.containsKey(cls);
      }
   ...
   static String getString(Pointer pointer, long offset, String encoding) {
      ...
      if (encoding != null) {
         String var10000;
         try {
            var10000 = new String(data, encoding);
   ...
   static {
      ...
      if (!isCompatibleVersion("5.1.0", getNativeVersion())) {
         ...
         MAX_ALIGNMENT = !Platform.isSPARC() && !Platform.isWindows() && (!Platform.isLinux() || !Platform.isARM() && !Platform.isPPC()) && !Platform.isAIX() && !Platform.isAndroid() ? LONG_SIZE : 8;
