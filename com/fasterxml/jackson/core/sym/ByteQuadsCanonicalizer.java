...
public final class ByteQuadsCanonicalizer {
   ...
   // $FF: synthetic method
   static int access$000(ByteQuadsCanonicalizer x0) {
      return x0._hashSize;
   }

   // $FF: synthetic method
   static int access$100(ByteQuadsCanonicalizer x0) {
      return x0._count;
   }

   // $FF: synthetic method
   static int access$200(ByteQuadsCanonicalizer x0) {
      return x0._tertiaryShift;
   }

   // $FF: synthetic method
   static int[] access$300(ByteQuadsCanonicalizer x0) {
      return x0._hashArea;
   }

   // $FF: synthetic method
   static String[] access$400(ByteQuadsCanonicalizer x0) {
      return x0._names;
   }

   // $FF: synthetic method
   static int access$500(ByteQuadsCanonicalizer x0) {
      return x0._spilloverEnd;
   }

   // $FF: synthetic method
   static int access$600(ByteQuadsCanonicalizer x0) {
