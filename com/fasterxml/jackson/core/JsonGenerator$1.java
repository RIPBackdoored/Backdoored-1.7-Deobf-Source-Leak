...
// $FF: synthetic class
class JsonGenerator$1 {
   // $FF: synthetic field
   static final int[] $SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion = new int[WritableTypeId$Inclusion.values().length];
