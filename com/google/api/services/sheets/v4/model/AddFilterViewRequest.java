...
public final class AddFilterViewRequest extends GenericJson {
   ...
   public AddFilterViewRequest setFilter(FilterView var1) {
      this.filter = var1;
      return this;
   }

   public AddFilterViewRequest set(String var1, Object var2) {
      return (AddFilterViewRequest)super.set(var1, var2);
   }
